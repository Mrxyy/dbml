...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c302 = peg$literalExpectation("local", true),
      peg$c303 = "time",
      peg$c304 = peg$literalExpectation("time", true),
      peg$c305 = "zone",
      peg$c306 = peg$literalExpectation("zone", true),
      ...
      peg$c308 = "timetz",
      peg$c309 = peg$literalExpectation("timetz", true),
      ...
      peg$c311 = function(number, dimensions) {
        const args = number ? number[2] : null;
        return {
      ...
      peg$c312 = function(c, dimensions) {
                const args = c.args;
          return {
      ...
      peg$c316 = function(pathName, c, args) {
      ...
      peg$c317 = "array",
      peg$c318 = peg$literalExpectation("array", true),
      peg$c319 = "[",
      peg$c320 = peg$literalExpectation("[", false),
      peg$c321 = "]",
      peg$c322 = peg$literalExpectation("]", false),
      peg$c323 = function(singledimenson) {
          return [singledimenson ? singledimenson[3] : ''];
              },
      peg$c324 = function(multidimenson) {
          // this will parse into Array(Array('[', _ , expression , _ ']'))
          return multidimenson.map((dimension) => dimension[2]);
        },
      peg$c325 = function(val) { return { value: val, type: 'string' }},
      peg$c326 = function(val) { return { value: val, type: 'number' }},
      peg$c327 = function(val) { return { value: val, type: 'boolean' }},
      peg$c328 = function(val) {
                      let str = val;
      ...
      peg$c335 = peg$otherExpectation("endline"),
      peg$c336 = peg$otherExpectation("newline"),
      peg$c337 = "\r\n",
      peg$c338 = peg$literalExpectation("\r\n", false),
      peg$c339 = "\n",
      peg$c340 = peg$literalExpectation("\n", false),
      peg$c341 = peg$otherExpectation("space"),
      peg$c342 = peg$otherExpectation("comment"),
      peg$c343 = "--",
      peg$c344 = peg$literalExpectation("--", false),
      peg$c345 = /^[^\n]/,
      peg$c346 = peg$classExpectation(["\n"], true, false),
      peg$c347 = "/*",
      peg$c348 = peg$literalExpectation("/*", false),
      peg$c349 = "*/",
      peg$c350 = peg$literalExpectation("*/", false),
      peg$c351 = peg$otherExpectation("letter, number, underscore, or Chinese character"),
      peg$c352 = /^[a-z0-9_\u4E00-\u9FFF]/i,
      peg$c353 = peg$classExpectation([["a", "z"], ["0", "9"], "_", ["\u4E00", "\u9FFF"]], false, true),
      peg$c354 = "&&",
      peg$c355 = peg$literalExpectation("&&", false),
      peg$c356 = "=",
      peg$c357 = peg$literalExpectation("=", false),
      peg$c358 = "engine",
      peg$c359 = peg$literalExpectation("ENGINE", true),
      peg$c360 = function(table_name, table_properties) {
      ...
      peg$c362 = function(table_constraint) {
                      return {
                              table_property_name: "table_constraint",
                              value: table_constraint
                      }
              },
      peg$c363 = function(source_table) {
                      return {
                              table_property_name: "like",
                              value: source_table
                      }
              },
      peg$c364 = function(column_name, data_type, column_constraints) {
      ...
      peg$c365 = function(constraint_name) { return constraint_name },
      peg$c366 = function(constraint_name) { return { type: "not_null" , value: true } },
      peg$c367 = function(constraint_name) { return { type: "not_null" , value: false } },
      peg$c368 = function(constraint_name) { return { type: "not_supported" } },
      peg$c369 = function(constraint_name, default_expr) { return { type: "dbdefault", value: default_expr } },
      peg$c370 = function(constraint_name) { return { type: "increment" } },
      ...
      peg$c466 = function(alter_sub_syntax) {
              return {
      ...
      peg$c474 = function(name, actions) {
      ...
      peg$c475 = function(table_constraint) { // reuse table_constraint in Create_table_normal.pegjs
                      return table_constraint;
              },
      peg$c476 = function(column_name, data_type, e) {return e},
      peg$c477 = function(column_name, data_type, expression) {
                      return {
                              type: "type",
                              expression
                      }
              },
      peg$c478 = function(column_name, expression) {
                      return {
                              type: "set_default",
                              expression
                      }
      ...
      peg$c480 = function(column_name, action) {
      ...
      peg$c483 = function(column_name) {
                      return {
                              type: "reset_options"
                      }
              },
      peg$c484 = function(column_name, value) {
                      return {
                              type: "set_storage",
      ...
      peg$c489 = function(unique) {return null},
      peg$c490 = function(unique, name) {return name},
      peg$c491 = function(unique, name, table_name, type) {return type},
      peg$c492 = function(unique, name, table_name, type, index_properties) {
                      const value = {
      ...
      peg$c493 = function(c, c1) {return {value: `${c}(${removeReduntdantSpNewline(_.flattenDeep(c1).join(""))})`, type: "expression" }},
      peg$c494 = function(c) { return {value: `${c}`, type: "string" }},
      peg$c495 = function(e) {return { value:`${e}`, type: "expression"}},
      peg$c496 = "COLLATE",
      peg$c497 = peg$literalExpectation("COLLATE", false),
      peg$c498 = "ASC",
      peg$c499 = peg$literalExpectation("ASC", false),
      peg$c500 = "DESC",
      peg$c501 = peg$literalExpectation("DESC", false),
      peg$c502 = "NULLS",
      peg$c503 = peg$literalExpectation("NULLS", false),
      peg$c504 = "FIRST",
      peg$c505 = peg$literalExpectation("FIRST", false),
      peg$c506 = "LAST",
      peg$c507 = peg$literalExpectation("LAST", false),
      peg$c508 = function(column) {
              return column;
      },
      peg$c509 = "vacuum_cleanup_index_scale_factor",
      peg$c510 = peg$literalExpectation("vacuum_cleanup_index_scale_factor", true),
      peg$c511 = "buffering",
      peg$c512 = peg$literalExpectation("buffering", true),
      peg$c513 = "fastupdate",
      peg$c514 = peg$literalExpectation("fastupdate", true),
      peg$c515 = "gin_pending_list_limit",
      peg$c516 = peg$literalExpectation("gin_pending_list_limit", true),
      peg$c517 = "pages_per_range",
      peg$c518 = peg$literalExpectation("pages_per_range", true),
      peg$c519 = "autosummarize",
      peg$c520 = peg$literalExpectation("autosummarize", true),
      peg$c521 = function(comment_option, text) {
      ...
      peg$c522 = function(path, column_name) {
      ...
      peg$c526 = function() { return { syntax_name: "insert" } },
      peg$c527 = function() { return { syntax_name: "set" } },
      peg$c528 = function() { return { syntax_name: "reset" } },
      peg$c529 = function() { return { syntax_name: "select" } },
      peg$c530 = function() { return { syntax_name: "drop" } },
      peg$c531 = function() { return { syntax_name: "use" } },
      peg$c532 = function() { return { syntax_name: "create_sequence" } },
      peg$c533 = function() { return { syntax_name: "create_schema" } },
      peg$c534 = function() { return { syntax_name: "create_view" } },
      peg$c535 = function() { return { syntax_name: "alter_not_table" } },
      peg$c536 = function() { return { syntax_name: "comment_and_space" } },
      peg$c537 = function(value) {
        const loc = location();
        const t = text();
        return {
      ...
      peg$c538 = function(create_table) { return create_table },
  ...
  function peg$parseindex_storage_parameter() {
    ...
    if (s0 === peg$FAILED) {
      if (input.substr(peg$currPos, 33).toLowerCase() === peg$c509) {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s0 === peg$FAILED) {
            if (input.substr(peg$currPos, 22).toLowerCase() === peg$c515) {
            ...
            if (s0 === peg$FAILED) {
              ...
              if (s0 === peg$FAILED) {
                if (input.substr(peg$currPos, 13).toLowerCase() === peg$c519) {
